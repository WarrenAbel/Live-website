 ...
 * - does NOT rely on get_result()
 * - ignores random-format quote numbers
 * - continues from the largest #### that matches ^BCS-YYYY-\d{4}$
 */
$year = date('Y');
$prefix = "BCS-$year-";
...
try {
  // Only consider correctly formatted quote numbers (exactly 4 digits after prefix)
  $sqlMax = "
