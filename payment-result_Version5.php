<?php
// payment-result.php
// Landing page after PayFast redirects the customer back.
// Shows a friendly message based on the current quote status.

require __DIR__ . '/config.php';

// We expect PayFast to send back m_payment_id (your quote_number)
...
// Decide message based on status
...
if ($status === 'paid') {
    ...
    // ITN might not have processed yet
