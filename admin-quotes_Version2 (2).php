...
<head>
  ...
  <style>
    ...
    .pf-title { font-weight:700; font-size:0.75rem; color:#111827; }
      ...
      <?php else: ?>
        <?php foreach ($quotes as $q): ?>
          <?php
            ...
            // PayFast fields (may be NULL until ITN arrives)
          ...
          <tr>
            ...
            <td>
              ...
              <div class="pf-box">
                <div class="pf-title">PayFast</div>
                <div class="pf-row">Status: <strong><?php echo h($pfStatus ?: '—'); ?></strong></div>
                <div class="pf-row">pf_payment_id: <strong><?php echo h($pfId ?: '—'); ?></strong></div>
                <div class="pf-row">amount_gross: <strong><?php echo ($pfGross !== '' && $pfGross !== null) ? 'R ' . h(money($pfGross)) : '—'; ?></strong></div>
                <div class="pf-row">updated_at: <strong><?php echo h($pfUpdated ?: '—'); ?></strong></div>
              </div>
            </td>
            <td>
              <input type="text"
