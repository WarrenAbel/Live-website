...
$data = [
    ...
    // B2: PayFast returns here after payment attempt; this script verifies server-to-server before updating DB
    'return_url'    => $baseSite . '/payment-successful.php?m_payment_id=' . $quoteNumber,

    // Cancel fallback: updates DB immediately
